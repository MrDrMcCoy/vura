...
# Detect new disks and add them to the logical volume you store VURA on. This is optional, and requires configuration to match how you have set up your logical volumes. If you are not using logical volumes, please comment out this section.
bash /opt/diskadd.sh
sync
sleep 5
mount -a
